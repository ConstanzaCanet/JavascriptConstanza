...
function velMetMin(distancia,tiempo) {
  if (tiempo == 0) {
      return 'Ocurrió un error!'
  }else if(tiempo != 0){
    return (distancia/tiempo).toFixed(2) + ' metros/minuto';
  }         
}
...
function pasarKmxHora(distancia,tiempo) {
    if(tiempo == 0){
        return ('Eso  no es calculable lo siento')
    }else if(tiempo !=0){
...
console.log(pasarKmxHora(distancia1, tiempo1));
